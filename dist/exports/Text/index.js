...
import css from '../StyleSheet/css'; // import warning from 'fbjs/lib/warning';
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    if (process.env.NODE_ENV !== 'production') {// warning(this.props.className == null, 'Using the "className" prop on <Text> is deprecated.');
    }
